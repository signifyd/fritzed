...
<div class="row">
    <div class="col-lg-12">
        <h1><?php echo ($adminsOnly ? icon('lock', 'This thread is only viewable for admins') : ''); ?>Thread "<?php echo $thread['title']; ?>"<a href="?page=forum" class="btn btn-primary pull-right"><?php echo icon('list'); ?> Back to Forum</a></h1>
        <?php
        if(!empty($errors)) {
